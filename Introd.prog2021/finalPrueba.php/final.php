 ...
 * include_once_ incluye el archivo especificado SÓLO UNA VEZ, si se incluye más veces tan sólo devuelve true.
...
do {
    ...
    switch ($opcion) {
        ...
        case 6:
            ...
            echo "\n>> LISTADO DE JUEGOS ORDENADOS (alfabéticamente) POR JUGADOR O\n";
