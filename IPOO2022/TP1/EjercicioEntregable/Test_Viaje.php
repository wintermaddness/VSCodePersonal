		...
		while ($opcion != 0) {
			...
			if ($opcion == 1) {
				...
				if ($validacion == true) {
					...
					echo "\n    >>> ".$resultado."\n";
					if ($resultado == true) {
						echo "\n| Nombre del pasajero: ".$objViaje->getNombrePasajero()."\n";
						echo "| Apellido del pasajero: ".$objViaje->getApellidoPasajero()."\n";
						echo "| Documento del pasajeros: ".$objViaje->getDocumentoPasajero()."\n";
					}
