<?php
	...
	function menuDeOpciones() {
		...
		"\n| Opción 8: Ver datos de la empresa".
	...
	function crearViaje() {
		...
		$viajeCreado->cargar($codViaje, $destino, $capacidadMaxima, 1, $objResponsable, $precio, $tipoAsiento, $trayectoriaViaje);
